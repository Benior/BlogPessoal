	...
	public OpenAPI springBlogPessoalOpenAPI() {
		return new OpenAPI()
				...
				.license(new License()
						...
						.url("https://brazil.generation.org")) //informação da empresa
				.contact(new Contact() //contato e repositório do projeto
						.name("Benior Cardoso")
						.url("https://github.com/Benior/BlogPessoal")
						.email("benior.santos@gmail.com")))
				.externalDocs(new ExternalDocumentation()
						.description("Meu LinkedIn")
						.url("https://www.linkedin.com/in/beniorcardoso/"));
	}
